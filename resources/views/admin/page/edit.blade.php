...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Page - Edit') }}</div>

                <div class="card-body">
                    {!! Form::open(['route' => ['pages.update', $page->id], 'method' => 'put']) !!}

                    <div class="form-group @if($errors->has('thumbanil')) has-error @endif">
                        {!! Form::label('Thumbnail') !!}
                        {!! Form::text('thumbanil', $page->thumbanil, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                        @if($errors->has('thumbanil'))
                        <span class="help-block">{!! $errors->first('thumbanil') !!}</span>
                        @endif
                    </div>
                    ...
                    <div class="form-group @if($errors->has('details')) has-error @endif">
                        ...
                        {!! Form::textarea('details', $page->details, ['class' => 'form-control', 'placeholder' => 'Description']) !!}
