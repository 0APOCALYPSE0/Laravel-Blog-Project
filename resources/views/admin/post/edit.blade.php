            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group @if($errors->has('thumbanil')) has-error @endif">
                        ...
                        {!! Form::text('thumbanil', $post->thumbanil, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                    ...
                    <div class="form-group @if($errors->has('details')) has-error @endif">
                        ...
                        {!! Form::textarea('details', $post->details, ['class' => 'form-control', 'placeholder' => 'Description']) !!}
